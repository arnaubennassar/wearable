...
const personalDataIcon = (<Icon style={{marginTop: 40}} size={ wiz*0.3 } name={ "cog" } color={ '#B5B2B2' }/>);
const wearableIcon = (<Icon style={{marginTop: 40}} size={ wiz*0.3 } name={ "bluetooth-b" } color={ '#B5B2B2' }/>);
const logoutIcon = (<Icon style={{marginTop: 40}} size={ wiz*0.3 } name={ "power-off" } color={ '#B5B2B2' }/>);
